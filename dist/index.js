...
class ZetaChainMCPServer {
            ...
            try {
                ...
                switch (name) {
                    ...
                    case "estimate_cross_chain_fee":
                        ...
                        return await this.estimateCrossChainFee(toolArgs.fromChain, toolArgs.toChain, toolArgs.amount);
                    default:
    ...
    async getZetaChainBalance(address) {
    ...
    async estimateCrossChainFee(fromChain, toChain, amount) {
        // Mock implementation - replace with actual ZetaChain API calls
        return {
            content: [
                {
